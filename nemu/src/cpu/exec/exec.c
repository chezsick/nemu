...
/* 0xe8 */	call_i_v, jmp_i_v, jmp_ptr, jmp_i_b,
...
/* 0x44 */	cmove_rm2r_v, inv, cmovbe_rm2r_v, cmova_rm2r_v,
...
/* 0x8c */	jl_i_v, jg_i_v, jle_i_v, jge_i_v, 
/* 0x90 */	inv, inv, setb_rm_v, setae_rm_v,
...
make_helper(exec) {
	printf("exec line 231\n");
	ops_decoded.opcode = instr_fetch(eip, 1);
	printf("exec line 233\n");
	return opcode_table[ ops_decoded.opcode ](eip);
}

static make_helper(_2byte_esc) {
	eip ++;
	printf("exec line 239\n");
